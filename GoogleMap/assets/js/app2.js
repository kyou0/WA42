...
App.cart = {
  ...
  render: function () {
    ...
    // 削除ボタンのイベント
    $elem.find(".js-remove-item").on("click", function (e) {
    ...
    // 数量変更のイベント
    $elem.find(".js-change-quantity").on("change", function (e) {
    ...
    $("#cart .total-price").text(this.total_price);
